        ...
        <form className="animal-registration" onSubmit={props.onAnimalRegistration}>
            <div className="form-group row">
                ...
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="name" id="animal-name" placeholder="Oliver" />
                </div>
            </div>
            <div className="form-group row">
                <label htmlFor="animal-species" className="col-sm-2 col-form-label animal-form-label">Species</label>
                <div className="col-sm-10">
                    <select name="species" id="animal-species" className="form-control">
            ...
            <div className="form-group row">
                ...
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="breed" id="animal-breed" placeholder="Bulldog" />
                </div>
            </div>
            <div className="form-group row">
                <label htmlFor="animal-color" className="col-sm-2 col-form-label animal-form-label">Color</label>
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="color" id="animal-color" placeholder="White" />
                </div>
            </div>
            <div className="form-group row">
                <label htmlFor="animal-age" className="col-sm-2 col-form-label animal-form-label">Age</label>
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="age" id="animal-age" placeholder="1" />
                </div>
            </div>
            <div className="form-group row">
                <label htmlFor="animal-location" className="col-sm-2 col-form-label animal-form-label">Location</label>
                <div className="col-sm-10">
                    <input type="text" className="form-control" name="location" id="animal-location" placeholder="Guadalajara" />
                </div>
            </div>
            <div className="form-group row">
                ...
                <div className="col-sm-10 custom-file">
                    <input onChange={props.handleFileUpload} type="file" name="picture" className="custom-file-input" />
